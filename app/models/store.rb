...
class Store < ApplicationRecord
  ...
  validates :digital_address, presence: true, uniqueness: true, length: { minimum: MIN_LENGTH, maximum: MAX_LENGTH }
  validates :purpose_of_structure, uniqueness: true, presence: true,
    length: { minimum: MIN_LENGTH, maximum: MAX_LENGTH }
